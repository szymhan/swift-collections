#
#  Be sure to run `pod spec lint OrderedCollections.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.3"
  spec.summary      = "A short description of OrderedCollections."
  ...
  spec.source       = { :git => "https://github.com/szymhan/swift-collections.git", :tag => "#{spec.version}" }
